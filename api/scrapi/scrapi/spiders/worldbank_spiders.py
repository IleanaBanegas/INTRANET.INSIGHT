...
class WorldbankSpiders(scrapy.Spider):
    name = 'worldbank_spiders'
    start_urls = ['https://projects.worldbank.org/en/projects-operations/procurement?showrecent=true&srce=notices']
    # custom_settings = {
    #     'FEED_URI': 'worldbank_spiders.json',
    #     'FEED_FORMAT': 'json'
    # }

    def parse(self, response):
        descriptions = response.xpath('//div[@class="projects_tab parbase section"]//div[@class="container"]//table[@class="project-opt-table"]').getall()


        # /tbody/tr/td[@data-th="Project Title:"]/a/font/font/text()
